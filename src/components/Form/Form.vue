  ...
  <div class="p-6 bg-gray-100 rounded-lg shadow-md mt-5">
    <div class="container p-6">
      ...
      <form @submit.prevent="handleSubmit">
        <div class="mb-4 flex flex-col lg:flex-row items-center justify-center">
          <label for="name" class="text-green-700 font-medium mb-2 lg:mb-0 lg:mr-4 text-[25px] w-full lg:w-1/3">Ism
            Familiyangizni kiriting</label>
          <input type="text" id="name" v-model="formData.name"
            class="w-full lg:w-2/4 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600" />
        </div>
        <div class="mb-4 flex flex-col lg:flex-row items-center justify-center">
          <label for="region" class="text-green-700 font-medium mb-2 lg:mb-0 lg:mr-4 text-[25px] w-full lg:w-1/3">O'zingiz
            yashaydigan viloyat</label>
        ...
        <div class="mb-4 flex flex-col lg:flex-row items-center justify-center">
          <label for="phone" class="text-green-700 font-medium mb-2 lg:mb-0 lg:mr-4 text-[25px] w-full lg:w-1/3">Telefon
            raqamingizni kiriting</label>
          <input type="tel" id="phone" v-model="formData.phone"
            class="w-full lg:w-2/4 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600" />
        </div>
        <div class="mb-4 flex flex-col lg:flex-row items-center justify-center">
          <label for="type" class="text-green-700 font-medium mb-2 lg:mb-0 lg:mr-4 text-[25px] w-full lg:w-1/3">Band
            qilish turini tanlang</label>
        ...
        <div class="flex justify-center lg:justify-end items-center w-full lg:w-[92%]">
          <button type="submit" class="bg-[#3D5F01] mt-4 text-white font-roboto px-4 py-2 rounded-tl-3xl rounded-br-3xl">
            Tasdiqlash
          </button>
        </div>
      </form>
