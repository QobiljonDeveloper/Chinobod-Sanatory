        ...
        <div class="container">
            <div class="flex justify-center w-full komfort gap-16">
                <div class="flex flex-col gap-5">
                    <p class="text-[#4E6B20] text-2xl font-semibold text-center">Standard, 2 xona 2 krovat</p>
                ...
                <div>
                    <div class="flex flex-col items-center gap-5">
                        <div class="">
                            <p class="text-red-600 text-2xl font-medium text-center">1 Kun uchun narx : 300.000</p>
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            <p class="text-base text-[#4E6B20]">300,000</p>
