<template>
    <div class="bg min-h-screen flex justify-center items-center p-4">
        <div class="container mx-auto">
            <div class="flex flex-col lg:flex-row justify-center w-full komfort gap-16">
                <!-- Left Column -->
                <div class="flex flex-col gap-5 w-full lg:w-1/3">
                    <p class="text-[#4E6B20] text-xl lg:text-2xl font-semibold text-center">Lux , Suit 2 to'shak, 1 xonali</p>
                    <div class="video right border-4 border-[#fff] rounded-lg overflow-hidden">
                ...
                <div class="w-full lg:w-1/3">
                    <div class="flex flex-col items-center gap-5">
                        <p class="text-red-600 text-xl lg:text-2xl font-medium text-center">1 Kun uchun narx : 400.000</p>
